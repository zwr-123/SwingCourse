...
public class EditStudentDialog extends JDialog
{
	...
	public EditStudentDialog(JFrame owner)
	{
		...
		root.setLayout(new MyColumnLayout(10));
		root.padding(10);
		
		// 中间面板
		AfPanel main = new AfPanel();
		root.add(main, "1w"); // 占居中间区域
		main.setLayout(new MyColumnLayout(10));		
		...
		if(true)
		{
			...
			main.add(row,"24px");
			row.setLayout(new MyRowLayout(10));
		...
		bottom.setLayout(new MyRowLayout(10));
